...
export const experience: ExperienceEntry[] = [
  {
    ...
    summary:
      "Started on the Legal Technology team, building a platform to streamline communication and data requests with law enforcement. Now on Helix, helping solve customer issues proactively using aggregated T-Mobile data and LLMs.",
